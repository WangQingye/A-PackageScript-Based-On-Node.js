...
<!-- CreationDate: Thu Dec 15 16:17:40 2016 -->
...
multi&minus;threading for encoding, if possible. This option
is only effective when using lossy compression on a source
with a transparency channel.</p></td>
</table>
