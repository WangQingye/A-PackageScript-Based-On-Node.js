...
OPTIONS
      ...
      near_lossless int
              Use nearlossless image preprocessing. This option adjusts pixel
      ...
      q float
              ...
              In  case  of  lossless  compression  (specified by thelossless
   ...
   LOSSY OPTIONS
      ...
      size int
              ...
              get. If bothsize andpsnr are used,size value will prevail.
      ...
      pass int
              ...
              by  options size  orpsnr. Maximum value is 10, default is 1.
              If optionssize orpsnr were used, butpass wasnt specified,
