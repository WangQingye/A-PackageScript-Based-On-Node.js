...
NAME
       webpmux    create  animated  WebP files from nonanimated WebP images,
...
OPTIONS
   ...
   FRAME_OPTIONS frame)
       Create  an animated WebP file from multiple (nonanimated) WebP images.
...
EXAMPLES
       ...
       Create an animated WebP file from 3 (nonanimated) WebP images:
