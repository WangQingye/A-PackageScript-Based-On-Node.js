...
<!-- CreationDate: Thu Dec 15 16:17:41 2016 -->
...
<p style="margin-left:11%;"><b>&minus;min_size</b></p>
...
combined with &minus;q, &minus;m, &minus;lossy or
&minus;mixed options.</p>
...
key frames. A &rsquo;kmax&rsquo; value of 0 will result in
all frames being key frames. Typical values are in the range
3 to 30. Default values are kmin = 9, kmax = 17 for lossless
