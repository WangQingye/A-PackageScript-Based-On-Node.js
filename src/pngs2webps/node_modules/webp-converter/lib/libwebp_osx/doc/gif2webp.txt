...
OPTIONS
      ...
      kmax int
              ...
              A  kmin  value  of  0 will turn off insertion of key frames. A
              kmax value of 0 will result in all frames  being  key  frames.
              Typical values are in the range 3 to 30. Default values are kmin
