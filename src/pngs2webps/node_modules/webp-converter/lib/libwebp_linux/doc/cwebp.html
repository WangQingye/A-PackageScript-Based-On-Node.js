...
<!-- CreationDate: Thu Dec 15 16:10:52 2016 -->
...
<p style="margin-left:22%;">Use near&minus;lossless image
preprocessing. This option adjusts pixel values to help
compressibility, but has minimal impact on the visual
quality. It triggers lossless compression mode
automatically. Range is 0 (maximum preprocessing) to 100 (no
preprocessing, the default).</p>
...
size than slower ones. A good default is <b>&minus;z 6</b>.
This option is actually a shortcut for some predefined
settings for quality and method. If options <b>&minus;q</b>
or <b>&minus;m</b> are subsequently used, they will
invalidate the effect of this option.</p></td></tr>
</table>
...
<p>Use multi&minus;threading for encoding, if possible.
This option is only effective when using lossy compression
on a source with a transparency channel.</p></td></tr>
</table>
...
<p>Turns auto&minus;filter on. This algorithm will spend
additional time optimizing the filtering strength to reach a
well&minus;balanced quality.</p></td></tr>
</table>
